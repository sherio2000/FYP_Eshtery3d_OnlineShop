...
const routes: Routes = [
  ...
  {path: 'admin/login', component: LoginComponent, data: {breadcrumb: {skip: true}}},
  {path: 'admin/home', canActivate: [AdminAuthGuard], component: AdminHomeComponent, data: {breadcrumb: {skip: true}}},
  {path: 'admin', component: LoginComponent, data: {breadcrumb: {skip: true}}},
